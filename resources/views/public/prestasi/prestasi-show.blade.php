<x-layout>
    ...
    <div class="mx-5 md:mx-40 mt-30 mb-10">
        <x-sub-url>
            ...
            <x-slot:judul>JUARA UMUM LKTI NASIONAL MIPA UNY</x-slot:judul>
        </x-sub-url>


        <div class="my-5 border-b border-gray-300 pb-5">
            <img src="{{ url('/') }}/images/banner/bg.jpg" alt="" class="w-full">
            <h2 class="text-blue-950 text-2xl font-bold mt-10">JUARA UMUM LKTI NASIONAL MIPA UNY</h2>
            ...
            <div class="flex justify-start text-gray-600 text-sm text-justify">
                ...
                <span class="md:pt-3 pt-6 pl-2">:</span>
                <span class="md:pt-3 pt-6 pl-2">
