<x-layout>
    ...
    <div class="md:mx-20 mx-5 mt-30 mb-10">
        ...
        {{-- start sidebar --}}
        <div class="max-w-sm mx-auto md:pr-8 pr-3 mt-5">
            ...
            <form class="max-w-full w-sm">
                ...
                <div class="relative">
                    ...
                    <input type="search" id="default-search" name="search" autocomplete="off"
                        ...
                        placeholder="Cari Prestasi..." required />
                    <button type="submit"
        ...
        <div class="w-full my-5 flex justify-start flex-wrap">
            ...
            @foreach ($prestasis as $prestasi)
                <div class="flex justify-start bg-white shadow-lg rounded-lg overflow-hidden flex-wrap my-10 w-full">
                    <!-- Bagian Gambar -->
