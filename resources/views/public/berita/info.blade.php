    ...
    <div class="md:mx-20 mx-5 mt-30 mb-10">
        ...
        <div class="w-full my-5 flex justify-start flex-wrap">
            ...
            <div class="max-w-sm md:pr-8 pr-3">
                ...
                <form class="max-w-full w-sm">
                    ...
                    <div class="relative">
                        ...
                        <button type="submit"
                            class="text-white absolute end-2.5 bottom-2.5 bg-blue-950 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-950 dark:focus:ring-blue-800">Search</button>
                    </div>
                </form>
            ...
            <div class="max-w-full md:w-2/3 w-full md:p-5 p-0 md:mt-0 mt-10">
                <div
                    class="max-w-full w-full sm:mx-0  mb-5 md:mx-5 bg-white border border-gray-200 shadow-sm dark:bg-gray-800 dark:border-gray-700 relative overflow-hidden">
                    <div>
                    ...
                    <div class="p-5">
                        <a href="{{ url('/') }}/info/1">
                            <h5
                                ...
                                PENILAIAN AKHIR SEMESTER GANJIL T.P. 2024/2025</h5>
                        </a>
