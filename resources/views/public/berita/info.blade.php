        ...
        <div class="w-full my-5 flex justify-start flex-wrap">
                ...
                <form class="max-w-full w-sm">
                    ...
                    <div class="relative">
                        ...
                        <input type="search" id="default-search" name="search" autocomplete="off"
                            ...
                            placeholder="Cari Informasi..." required />
                        <button type="submit"
                            class="text-white absolute end-2.5 bottom-2.5 bg-blue-950 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 ">Search</button>
                    </div>
                </form>
            ...
            <div class="max-w-full md:w-2/3 w-full md:p-5 p-0 md:mt-0 mt-10">
                ...
                @foreach ($sekolahs as $sekolah)
                    <?php $parts = explode(' ', $sekolah['tanggal']);
                    $tanggal = $parts[0];
                    ...
                    <div
                        ...
                        <div>
                            <img class="h-80 w-full" src="{{ asset('storage/' . $sekolah['image']) }}"
                                alt="{{ $sekolah['image'] }}" />
