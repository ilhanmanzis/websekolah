                ...
                <form class="max-w-full w-sm">
                    ...
                    <div class="relative">
                        ...
                        <input type="search" id="default-search" name="search"
                            ...
                            placeholder="Apa yang anda cari..." autocomplete="off" required />
                        <button type="submit"
